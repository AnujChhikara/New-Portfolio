...
export default function ProjectCard({ProjectName, VideoUrl, Tech, Brief, GithubLink, LiveLink}:{ProjectName:string, VideoUrl:string, Tech:string[], Brief:string, GithubLink:string, LiveLink:string} ) {
   
    return (
    <div className='w-[600px] h-[300px]  flex border border-[#1b1b1b] rounded-xl'>
        <div className='w-1/2 flex items-center  px-2 py-4'>
        <video className="rounded-xl" controls>
        <source src={VideoUrl} type="video/mp4"/> 
        Your browser does not support the video tag.
        </video>
        </div>
        <div className='w-1/2 flex flex-col justify-around space-y-4 px-2 py-4'>
            ...
            <div>
                <ul className='flex flex-wrap gap-2'>
                    {
                        Tech.map((item:any) => (
                            <li key={item} className='bg-[#1b1b1b] px-2 py-1 text-sm rounded-md'>{item}</li>
                        ))
                    }
            ...
            <div className='flex justify-around text-sm font-semibold'>
                <div className='bg-[#1b1b1b] px-2 py-1 rounded-md flex space-x-2'>
                    <svg className=" w-6 " fill="white" viewBox="0 -0.5 25 25"  xmlns="http://www.w3.org/2000/svg" >
