      ...
      <div className='md:w-1/2 flex flex-col justify-around space-y-4 px-4 py-4'>
        ...
        <div>
          <ul className='flex flex-wrap gap-2'>
            {Tech.map((item: any) => (
              <li
                key={item}
                className='bg-[#181818] px-3  py-1 text-sm rounded-md'
              >
                {item}
              </li>
            ))}
        ...
        <div className='flex  justify-between space-x-2 text-sm font-semibold'>
          <a
            target='_blank'
            href={GithubLink}
            className='bg-[#181818] h-12 font-medium  hover:bg-[#252525] duration-300 px-2 py-2 rounded-md flex items-center space-x-2'
          >
            <svg
              className=' w-6 '
              fill='white'
