...
export default function ContactMe() {
  return (
    <div className=' md:flex sm:flex sm:flex-wrap md:flex-nowrap  pt-6 lg:space-x-3 sm:gap-x-4 md:gap-x-0 sm:gap-y-3 md:gap-y-0'>
      <a
        href='https://github.com/AnujChhikara'
        className='bg-[#262626] w-32  px-4 py-2 hover:bg-[#1b1b1b] duration-500 rounded-lg font-semibold flex space-x-2 items-center'
        aria-label='Github'
      >
        <svg
          className=' w-6 '
