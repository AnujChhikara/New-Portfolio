...
const CARD_BASE_CLASSES =
  "rounded-xl border-2 border-dotted border-neutral-300 dark:border-neutral-600 hover:shadow-lg transition-all duration-300 bg-white dark:bg-neutral-900";
  ...
  return (
    <section className="w-full  pt-12" aria-label="About and projects">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 auto-rows-fr">
        ...
        {/* Tech Stack Card */}
        <article
          className={`md:row-span-2 ${CARD_BASE_CLASSES} p-3 sm:p-4 md:p-6 group overflow-hidden min-h-[300px] sm:min-h-[400px] md:min-h-0`}
        >
          <TechStack />
        </article>
