...
const FADE_TOP_CLASSES =
  "absolute top-0 left-0 right-0 h-10 bg-linear-to-b from-neutral-700 dark:from-neutral-900 via-neutral-700/80 dark:via-neutral-900/80 to-transparent z-10 pointer-events-none";
const FADE_BOTTOM_CLASSES =
  "absolute bottom-0 left-0 right-0 h-10 bg-linear-to-t from-neutral-700 dark:from-neutral-900 via-neutral-700/80 dark:via-neutral-900/80 to-transparent z-10 pointer-events-none";
