...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    <article className="rounded-xl border-2 border-dotted border-neutral-200 dark:border-neutral-600 p-4 sm:p-6 hover:shadow-lg transition-all duration-300 group flex flex-col h-full">
