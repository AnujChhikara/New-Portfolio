                  ...
                  return (
                    <li key={link.name}>
                      <LinkPreview url={link.url} width={280} height={175}>
                        <div
                          className="flex items-center justify-center w-11 h-11 sm:w-10 sm:h-10 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:border-neutral-300 dark:hover:border-neutral-700 transition-all duration-300 group touch-manipulation active:scale-95"
